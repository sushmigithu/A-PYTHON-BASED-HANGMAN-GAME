...
def Register():
    ...
    Reg = tk.Tk()
    Reg.title('User Register')
    Reg.geometry('700x700')

    # Background Colors
    Reg.configure(background='#C0C0C0')
    ...
    # Top Frame
    top_frame = Label(Reg, text='User Registration',font = ('Cosmic', 25, 'bold'), bg='#7268A6',relief='groove',padx=500, pady=30)
