...
def Log():
    ...
    # Background Colors
    Login.configure(background='#add8e6')
    ...
    # Top Frame
    top_frame = Label(Login, text='User Login',font = ('Cosmic', 25, 'bold'), bg='#add8e6',relief='groove',padx=500, pady=30)
    ...
    def Search(arg = None):
        if username_entry.get() == '': 
            ...
            if results:
                Login.destroy()
                print("wel")
                subprocess.call("python MainProMAX.py")
